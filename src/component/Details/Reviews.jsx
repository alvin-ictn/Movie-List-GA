...
import { movie, review } from '../../database/db'
...
export default function Reviews(){
  ...
  useEffect(() => {
    if(reviw) {
      reviw.map(item => console.log(item))
    }
  },[dataMovie, reviw])
      ...
      <Container>
        <div className={styles["movie--details--review--post"]}>
          ...
          <div className={styles["movie--details--review--post--action"]}>
            ...
            <Row>
              <Col sm={10} className={styles.textBox}><textarea onChange={(e) => handleInput(e)}className="form-control" rows="3"></textarea></Col>
